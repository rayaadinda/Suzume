...
import { statuses, labels, users, tasks, taskAssignees, taskLabels } from './schema';
...
async function seed() {
  ...
  try {
    ...
    await db.insert(statuses).values([
      ...
      { id: 'in-progress', name: 'In Progress', color: '#facc15', displayOrder: 2 },
      { id: 'technical-review', name: 'Technical Review', color: '#22c55e', displayOrder: 3 },
      { id: 'paused', name: 'Paused', color: '#0ea5e9', displayOrder: 4 },
      { id: 'completed', name: 'Completed', color: '#8b5cf6', displayOrder: 5 },
    ]);
